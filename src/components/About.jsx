...
const About = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative text-white text-center overflow-x-hidden p-4">
      ...
      <div className="relative z-10 p-6 bg-pink-400 backdrop-blur-md rounded-2xl shadow-lg border border-pink-500/40 max-w-3xl transition-transform transform hover:scale-105 hover:border-white hover:shadow-white/50 flex flex-col sm:flex-row items-center space-y-6 sm:space-y-0 sm:space-x-10" onMouseOver={changeMood}>
